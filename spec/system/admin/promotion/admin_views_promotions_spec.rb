...
describe 'Administrador ve todas as promoções' do
  it 'com sucesso' do
    ...
    expect(page).to have_content 'BlackFriday (50%)'
    expect(page).to have_content 'Limite: 10'
    expect(page).to have_content 'Utilizado: 0'
    expect(page).to have_content "Início: #{I18n.l(1.day.from_now.to_date)}"
    expect(page).to have_content "Final: #{I18n.l(1.month.from_now.to_date)}"
  end
