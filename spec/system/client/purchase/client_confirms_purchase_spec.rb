...
describe 'Cliente confirma compra' do
  it 'com sucesso' do
    ...
    # balance_data = { client_wallet: { balance: 120.00, bonus_balance: 0.89 } }.to_json
    ...
    purchase_status_data = { transaction: { status: 'accepted' } }.to_json
    purchase_response = instance_double Faraday::Response, status: :created, body: purchase_status_data
    purchase_data_sent = { transaction: { registered_number: client.code, value: '120.89' } }.to_json
