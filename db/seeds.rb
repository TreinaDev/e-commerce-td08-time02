...
# Cashbacks
first_cashback = Cashback.create!(start_date: Date.today, end_date: 1.week.from_now, percentual: 20, admin:)
second_cashback = Cashback.create!(start_date: Date.today, end_date: 1.week.from_now, percentual: 10, admin:)
third_cashback = Cashback.create!(start_date: 1.month.from_now, end_date: 2.months.from_now, percentual: 5, admin:)
